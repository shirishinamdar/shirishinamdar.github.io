...
tags: [Snort, NIDS, Kali Linux, IDS, Lab]
...
- Network interface configured to monitor traffic from the lab network
...
Once the rule was applied and Snort was restarted, the system successfully generated alerts upon detecting the scan, confirming effective port scan detection within the lab environment.
